...
public class DisruptorContext {
	...
	private static final RingBuffer<LogEvent> ringBuffer = RingBuffer.createSingleProducer(LogEvent.EVENT_FACTORY, BUFFER_SIZE, new YieldingWaitStrategy());
	...
	private static final BatchEventProcessor<LogEvent> batchEventProcessor = new BatchEventProcessor<LogEvent>(ringBuffer , sequenceBarrier , handler);
