package com.jcLog.core.activemq;
...
import com.jcLog.util.PropertiesUtil;

/**
 * @description: activeMq工具类
 * @author：孙圣然
 * @created: 2013-10-25 下午2:08:47 
 * @version：$Id: ActivemqUtil.java 31944 2013-11-08 09:01:42Z sunsr $ 
...
public class ActivemqUtil {
	...
	static{
		...
		connectionFactory = new ActiveMQConnectionFactory(username,password,ip);
	}
	...
	/**
	 * @description 发布消息
	 * @param object 发布消息的bean
	 * @param destinationStr 目的地的str
	 */
